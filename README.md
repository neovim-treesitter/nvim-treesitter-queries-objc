# nvim-treesitter-queries-objc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-objc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-objc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **objc**, part of the
...
- [ ] Changes are scoped to `objc` — do not include files for other languages
